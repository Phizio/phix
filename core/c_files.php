...
//todo: написать еще два класса, один для листинга файлов (на случай работы вне репозитария)
//todo: второй: листинг репозитариев (версий) для навигации по хранилищу
