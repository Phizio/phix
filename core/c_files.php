...
//Репозетарий (сущность для хранения множества версий объекта (например файлы))
//todo: нужно написать листинг версий, создание файла с учетом версии
//todo: написать еще два класса, один для листинга файлов (на случай работы вне репозетария)
//todo: второй: листинг репозетариев (версий) для навигации по хранилищу
